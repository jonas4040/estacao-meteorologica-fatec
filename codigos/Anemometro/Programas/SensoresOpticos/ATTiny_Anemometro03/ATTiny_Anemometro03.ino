...
//    sensor03 = (PINB & (1 << PINB4)) == (1 << PINB4);
    sensor01 = (PINB & (1 << PINB1));
    sensor02 = (PINB & (1 << PINB3));
    sensor03 = (PINB & (1 << PINB4));
    delay(10);
    //-- Sensores estão pulled-up: portanto, precisa invertê-los
    sensores |= ~((sensor03 << 2) | (sensor02 << 1));
...
void setup() {
    ...
    PCMSK |= (1 << PCINT3) | (1 << PCINT4); // Configura os pinos PB1, PB3 e PB4 para uma interrupção de mudança de estado
}
